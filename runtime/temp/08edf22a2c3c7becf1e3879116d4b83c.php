<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpstudy_pro\WWW\myyds_tp5\public/../application/index\view\index\select_t.html";i:1639197297;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<br> -->
    ...
    <form action="<?php echo url('index/do_select_t'); ?>" method="post" enctype="multipart/form-data" class="form-style">
    ...
    <form action="<?php echo url('index/do_select_theme'); ?>" method="post" enctype="multipart/form-data" class="form-style">
