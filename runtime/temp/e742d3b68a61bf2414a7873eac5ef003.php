<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpstudy_pro\WWW\myyds_tp5\public/../application/index\view\user\paper_user.html";i:1642498451;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<body>
    ...
    <form action="<?php echo url('user/do_uploadpaper'); ?>" method="post" enctype="multipart/form-data" class="form-style">
