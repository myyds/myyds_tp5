<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpstudy_pro\WWW\myyds_tp5\public/../application/index\view\index\show_admin.html";i:1639197297;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    <form action="<?php echo url('index/do_add_user'); ?>" method="post" class="form-style">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id=au2>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    <form action="<?php echo url('index/do_add_teacher'); ?>" method="post" class="form-style">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?php echo url('index/publish_anno'); ?>" method="post" enctype="multipart/form-data" class="form-style">
                    ...
                    <body>
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                              ...
                              编辑</button> </a>&nbsp; &nbsp;<a href="<?php echo url('index/del',['id' => $vo['id']]); ?>" class="btn btn-danger btn-xs">
                              删除</button></a></td>
                                        </tr>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo url('admin/edit_teacher_admin',['id' => $v1['id']]); ?>" class="btn btn-success btn-xs">编辑</a>&nbsp; &nbsp;
                                                <a href="<?php echo url('index/del_t',['id' => $v1['id']]); ?>" class="btn btn-danger btn-xs">删除</a></td>
                                        </tr>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
