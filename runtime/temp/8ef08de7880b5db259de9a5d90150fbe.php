<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpstudy_pro\WWW\myyds_tp5\public/../application/index\view\index\uploadpaper2.html";i:1639197297;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
    <meta charset="utf-8">
...
<td>初稿
	<input type="hidden" name="old_paper" value="<?php echo $info['paper']; ?>"><!-- 输入img -->
...
<td>终稿
	<input type="hidden" name="old_paper" value="<?php echo $info['paper3']; ?>"><!-- 输入img -->
