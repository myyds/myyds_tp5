        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo url('teacher/ud_th'); ?>?id=<?php echo $data['id']; ?>">选题管理</a></li>
                    <li><a href="<?php echo url('teacher/show_check'); ?>?id=<?php echo $data['id']; ?>">用户管理</a></li>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal-body" style="text-align: center;">
                                            <form action="<?php echo url('teacher/do_updatapw_t'); ?>?id=<?php echo $data['id']; ?>" method="post" enctype="multipart/form-data" class="form-style">
                        ...
                        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal-body" style="text-align: center;">
                                            <form action="<?php echo url('teacher/do_edit_teacher'); ?>" method="post" enctype="multipart/form-data" class="form-style">
                        ...
                        <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal-body" style="text-align: center;">
                                            <form action="<?php echo url('teacher/do_add_theme'); ?>" method="post" enctype="multipart/form-data" class="form-style">
                        ...
                        <div>
                            <table class="table table-hover" style="position: absolute;top: 299px;">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo url('teacher/uploadpaper2',['id' => $vo['id']]); ?>"><button>查看文件</button></a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
